...
const MODEL_COLORS = ["#00D4FF", "#A78BFA", "#F59E0B", "#10B981"];
  ...
  if (modelNames.size === 0) {
    return (
      <div className="flex flex-col items-center justify-center h-40 gap-3">
        ...
        <p className="text-xs" style={{ color: "rgba(255,255,255,0.25)" }}>No per-model breakdown available</p>
        <p className="text-xs" style={{ color: "rgba(255,255,255,0.15)" }}>model_probs field not present in data</p>
      </div>
    );
  }
